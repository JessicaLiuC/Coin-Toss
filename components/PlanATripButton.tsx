...
import AirplaneTilt from '@/assets/dist/AirplaneTilt';
...
export default function PlanATrip({text, background = "white", style, textcolor, onClick}: IconTextButtonProps) {
